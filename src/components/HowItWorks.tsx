...
const steps = [
  {
    ...
    description: "Connectez votre téléphone pour synchroniser automatiquement les SMS Momo"
  },
  {
    step: "02",
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <div key={index} className="text-center group">
              <div className="text-gold text-6xl font-bold mb-4 group-hover:scale-110 transition-transform">
                {step.step}
              </div>
